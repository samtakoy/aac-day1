...
internal val AST_INTERESTING_TYPES = setOf(
    ...
    // companion_object is collected as a whole unit inside buildContainerChunk, not via collectNodes
...
internal val AST_CONTAINER_TYPES = setOf(
    "class_declaration",
    "object_declaration",
    // companion_object handled separately via collectCompanionChunks inside buildContainerChunk
)
