...
ВАЖНО: Используй инструменты не более 5 раз суммарно. После этого ОБЯЗАТЕЛЬНО напиши финальный отчёт без дополнительных вызовов инструментов.""",
                allowedTools = listOf(
                    "search_codebase",
                    "get_git_file_list",
                    "get_file_content",
...
2. При необходимости — не более 3 поисков: search_codebase для контекста
...
4. ОБЯЗАТЕЛЬНО завершай ответ текстовым отчётом — не делай бесконечных вызовов инструментов
