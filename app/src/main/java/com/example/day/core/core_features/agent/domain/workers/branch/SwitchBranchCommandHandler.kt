...
/**
 * Handles the "switch_branch" command.
 */
class SwitchBranchCommandHandler @Inject constructor(
    private val validator: BranchCommandValidator,
    private val branchManager: BranchManager,
    private val agentRepository: AgentRepository
) : CommandHandler {

    override val commandName = "switch_branch"
    ...
    override suspend fun handle(params: List<Pair<String, String?>>, chat: Chat): CommandResult {
        ...
        return when (val result = branchManager.switchBranch(agent.id, branchId)) {
