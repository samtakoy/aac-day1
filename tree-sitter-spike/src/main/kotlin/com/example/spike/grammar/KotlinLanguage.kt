...
/**
 * JVM-обёртка для tree-sitter Kotlin grammar.
 * Вручную написана по шаблону ktreesitter-plugin jvm.kt.in — без KMP actual/expect.
 *
 * Загрузка нативной либы:
 * 1. System.loadLibrary("kotlin") — из java.library.path
 * 2. Fallback: извлекаем из classpath /lib/{os}/{arch}/libkotlin.{ext}
 */
